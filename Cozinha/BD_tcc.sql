...
CREATE TABLE IF NOT EXISTS Conta(
    ...
    Status ENUM('esperando', 'preparando', 'pronta', 'cancelada') NOT NULL DEFAULT 'esperando',
);
...
INSERT INTO Conta (Senha, Pagamento, Status) VALUES
(1, 'A pagar', 'esperando'),
(2, 'paga', 'preparando');

INSERT INTO Pedido (Cod_conta, Cod_variacao, Qte, Valor_pedido) VALUES
(1, 1, 2, 7.00),
(1, 2, 1, 6.50),
(1, 3, 1, 10.00),
(2, 4, 1, 6.50),
